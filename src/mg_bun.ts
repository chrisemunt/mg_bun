...
export class server {
   ...
   version(): string {
      return mgbun_version();
   }

   dbversion(): string {
      if (this.init === 0) {
         const ret = mgbun_init();
         this.init ++;
      }
      return mgbun_dbversion();
   }
   ...
   open(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_OPEN, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   close(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_CLOSE, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   current_namespace(...args: any[]): string {
      ...
      if (args.length > 0) {
         ...
         const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_NSSET, 0);
      }
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_NSGET, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   set(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_GSET, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   get(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_GGET, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   delete(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_GDELETE, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   defined(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_GDEFINED, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   next(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_GNEXT, 0);
      get_result(pdata, result);
      return result.data;
   ...
   previous(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_GPREVIOUS, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   increment(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_GINCREMENT, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   lock(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_GLOCK, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   unlock(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_GUNLOCK, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   tstart(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_TSTART, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   tlevel(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_TLEVEL, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   tcommit(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_TCOMMIT, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   trollback(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_TROLLBACK, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   function(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_FUNCTION, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   classmethod(...args: any[]): any {
      ...
      const pdata = mgbun_command(ptr(this.buffer[bidx]), offset, DBX_CMND_CCMETH, 0);
      get_result(pdata, result);
   ...
   benchmark(...args: any[]): string {
      ...
      const pdata = mgbun_benchmark(ptr(this.buffer[bidx]), i, 0, 0);
      const data = new CString(pdata);
      return data;
   }
}
...
export class mglobal {
   ...
   set(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GSET, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   get(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GGET, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   delete(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GDELETE, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   defined(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GDEFINED, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   next(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GNEXT, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   previous(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GPREVIOUS, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   increment(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GINCREMENT, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   lock(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GLOCK, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   unlock(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GUNLOCK, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   merge(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_GMERGE, 0);
      get_result(pdata, result);
      return result.data;
   }
...
export class mclass {
   ...
   constructor(db: server, ...args: any[]) {
      ...
      if (args.length > 0) {
         ...
         if (args.length > 1 && this.db.init > 0) {
            ...
            const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_CCMETH, 0);
            get_result(pdata, result);
            if (result.type === DBX_DTYPE_OREF) {
   ...
   method(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_CMETH, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   getproperty(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_CGETP, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   setproperty(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_CSETP, 0);
      get_result(pdata, result);
      return result.data;
   }
   ...
   closeinstance(...args: any[]): string {
      ...
      const pdata = mgbun_command(ptr(this.db.buffer[bidx]), offset, DBX_CMND_CCLOSE, 0);
      get_result(pdata, result);
      return result.data;
   }
...
function get_result(pdata: FFIType.ptr, result: { data: string, error_message: string, type: number }): string {
   let data_properties = { len: 0, type: 0, sort: 0 };
   var buffer = new Uint8Array(8);
   buffer = new Uint8Array(toArrayBuffer(pdata, 0, 5), 0, 5);
   ...
   if (data_properties.sort === DBX_DSORT_ERROR) {
      if (data_properties.len === 0) {
         ...
         result.error_message = new CString(pdata, 5, data_properties.len);
      }
   }
   else {
      if (data_properties.len === 0) {
         ...
         result.data = new CString(pdata, 5, data_properties.len);
      }
   }
